...
export function QuoteSuccess({ quoteId }: QuoteSuccessProps) {
    const whatsappMessage = encodeURIComponent(
        `Hi BeeHouseholds, I submitted a quote request (Ref: ${quoteId}). Please follow up.`
    );
    ...
    return (
        <div className="min-h-screen bg-stone-50 flex items-center justify-center px-4 py-12">
            <div className="max-w-md w-full text-center">
                ...
                {/* Heading */}
                <h1 className="text-2xl font-bold text-brand-dark mb-2">Quote Request Received!</h1>
                ...
                <div className="bg-white rounded-xl border border-stone-200 p-5 mb-8">
                    ...
                    <p className="text-xl font-mono font-bold text-brand-dark">{quoteId}</p>
                    ...
                    <p className="text-xs text-brand-grey mt-2">
                        Or save this number to reference your request
                    </p>
                </div>
